...
💰💼 I have  created a React front-end with a Rails back-end and connect them to display a random message
 the link of the front-end project is [Click This Link](https://github.com/BenMKT/hello-react-front-end)....
...
```sh
  git clone  https://github.com/BenMKT/hello-rails-back-end.git
```
...
Feel free to check the [issues page](https://github.com/BenMKT/hello-rails-back-end/issues).
